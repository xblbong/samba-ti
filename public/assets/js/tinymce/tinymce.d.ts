...
interface WindowManagerImpl {
    open: <T extends DialogData>(config: Diapec<T>, params: WindowParams | undefined, closeWindow: (dialog: DialogInstanceApi<T>) => void) => DialogInstanceApi<T>;
